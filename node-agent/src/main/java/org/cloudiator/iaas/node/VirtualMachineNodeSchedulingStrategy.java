    ...
    try {
      ...
      switch (nodeCandidate.type()) {
        case IAAS:
          ...
          break;
        case SIMULATION:
          nodeType = NodeType.SIMULATION;
          break;
        default:
          throw new AssertionError("Illegal node type " + nodeCandidate.type());
      }

      return NodeBuilder.of(virtualMachine, nodeType).state(NodeState.RUNNING)
