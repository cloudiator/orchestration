...
public class JavaBundle implements Bundle {
    ...
    @Override public Set<String> dependencies(Environment environment) {
    ...
    @Override public Set<Download> downloads(Environment environment) {
    ...
    @Override public StatementList statements(Environment environment) {
        switch (environment.os().operatingSystemFamily().operatingSystemType()) {
            case WINDOWS:
