...
public class IdempotencyValidator {
  ...
  public static boolean checkIsInstalledViaProcess(RemoteConnection remoteConnection, String regExString) throws RemoteException {
  ...
  public static boolean checkIsInstalledViaFolder(RemoteConnection remoteConnection, String fullPath) throws RemoteException {
    RemoteConnectionResponse checkResult = remoteConnection
  ...
  public static boolean checkIsInstalledVisor(RemoteConnection remoteConnection) throws RemoteException {
    //check for installed Visor
    final boolean isInstalled = checkIsInstalledViaProcess(remoteConnection, "\"[v]isor.jar\"");

    LOGGER.debug(String.format("Exit code of visor process-search is %s", isInstalled ? "0" : "!=0"));

    return isInstalled;
  }

  public static boolean checkIsInstalledEMS(RemoteConnection remoteConnection) throws RemoteException {
